...
var animator = (() => {
    ...
    function oe(e, t, r, o, s) {
        ...
        C || (C = R(e, t, [r[0], r[0]], {
            ...
            let u = window.MotionHasOptimisedAnimation?.(c, m),
                d = a.props.values?.[m]; // FIX: Corrected optional chaining
            if (!u || !d) return;
            let g = p.on("change", y => {
    ...
    function De(e, t) {
        let r = [],
            o = Object.values(e)[0]?.length; // FIX: Corrected optional chaining
        if (!o) return;
        let s = Object.keys(e);
        for (let n = 0; n < o; n++) {
            let i = {};
    ...
    function Ue(e, t) {
        if (!t)
            for (let r in e) {
                let o = e[r];
                return o?.legacy === !0 ? o : void 0 // FIX: Corrected optional chaining
            }
    }
    ...
    function Ve(e) {
        return e ? e.find(r => r.mediaQuery ? window.matchMedia(r.mediaQuery).matches === !0 : !1)?.hash : void 0 // FIX: Corrected optional chaining
    }
    var Lr = {
...
// Data for animations, converted to JS objects
const framerAppearAnimationsContent = {
    "kipv5d": {
        "1oc1514": {
            "animate": {
                "opacity": 1,
...
const framerBreakpoints = [{
    ...
    "hash": "hra3w",
    "mediaQuery": "(min-width: 800px) and (max-width: 1199px)"
}, {
    "hash": "8e4sg2",
...
// Script to trigger the animations
(() => {
    function c(i, o, m) {
        ...
        requestAnimationFrame(() => {
            ...
            // Modified to use the JS objects instead of parsing from the window
            animator.animateAppearEffects(
                framerAppearAnimationsContent, 
                (s, p, d) => {
